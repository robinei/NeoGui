...
public struct DrawCommand {
    static DrawCommand() {
        ...
        Debug.Assert(Util.AlignmentOf<SetClipRectCommand>() == 4);
        Debug.Assert(Util.AlignmentOf<SetTransformCommand>() == 4);
        Debug.Assert(Util.AlignmentOf<SolidRectCommand>() == 4);
        Debug.Assert(Util.AlignmentOf<TexturedRectCommand>() == 4);
        Debug.Assert(Util.AlignmentOf<TextCommand>() == 4);
    }
