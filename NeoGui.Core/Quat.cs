...
namespace NeoGui.Core
{
    public struct Quat
    {
        ...
        public static Quat FromEulerAngles(Vec3 v)
        {
        ...
        public static Quat FromAxisAngle(Vec3 axis, float angle)
        {
            ...
            return new Quat((float)Math.Cos(angle), axis.X * temp, axis.Y * temp, axis.Z * temp);
        }

        public static Quat FromRotationArc(Vec3 from, Vec3 to)
        {
            var c = from.Cross(to);
            var d = from.Dot(to);
